...
<!DOCTYPE html>
 ...
 <head>
     <meta charset="UTF-8">
     <title>BCB - Reset Password</title> 
...
$formcontent=" \r\n You have requested a password reset on BCB. \r\n Go to BCB to reset your password for ' $username ':\r\nhttp://bcb.isobellennox.com/reset_password.php?user_id=".$user_id."&token=".time()."\r\nThis link will be good for one hour.";
$subject = "Password Reset On BCB";
